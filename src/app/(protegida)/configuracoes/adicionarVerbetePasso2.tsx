...
const INGREDIENTS_LIST = [
  ...
  'Sangue de galinha',
  'Sangue de porco',
  'Sementes de abóbora ou melancia',
  'Siri mole',
  'Tomate',
  'Toucinho',
  'Vinho tinto seco',
...
export default function AdicionarVerbetePasso2() {
  ...
  const [ingredients, setIngredients] = useState<
    { id: number; name: string | null; imageUri: string | null }[]
  >([{ id: 1, name: null, imageUri: null }]);
          ...
          <View key={item.id} style={styles.dynamicBlock}>
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>
                <Text style={styles.required}>*</Text> Ingrediente
              </Text>
