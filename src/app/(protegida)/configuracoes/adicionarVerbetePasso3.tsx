...
const COLORS = { primary: '#34523B', white: '#FFFFFF', textDark: '#333333', textLight: '#666666', border: '#CCCCCC', placeholder: '#888888', danger: '#D32F2F', uploadBg: '#FAFAFA' };
        ...
        {etapas.map((item) => (
          <View key={item.id} style={styles.dynamicBlock}>
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}><Text style={styles.required}>*</Text> Etapa de preparo</Text>
