...
export default function BuscaScreen() {
  ...
  const [activeTab, setActiveTab] = useState<CategoryType>(
    tab === 'restaurantes' ? 'restaurantes' : 'verbetes',
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mapContainer}>
        ...
        <Image source={require('../../../../assets/mock/map.png')} style={styles.mapImage} />
        ...
        {activeTab === 'restaurantes' && (
          <View style={styles.subTabContainer}>
            <TouchableOpacity onPress={() => setSubTab('todos')} style={styles.subTabItem}>
              <Text style={[styles.subTabText, subTab === 'todos' && styles.subTabActiveText]}>
                Todos
              </Text>
              {subTab === 'todos' && <View style={styles.subTabLine} />}
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setSubTab('cupom')} style={styles.subTabItem}>
              <Text style={[styles.subTabText, subTab === 'cupom' && styles.subTabActiveText]}>
        ...
        <FlatList
          ...
          renderItem={(
            ...
            activeTab === 'verbetes' ? (
              ...
              <RestaurantCardSearch item={item} moreDetailsPress={() => abrirDetalhes(item)} />
            )
          }
