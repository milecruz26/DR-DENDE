...
export type CategoriaVerbete = 'Entrada' | 'Sobremesa' | 'Acompanhamento' | 'Vegetariana' | 'Prato Principal';
...
export const MOCK_VERBETES: Verbete[] = [
  ...
  },
  {
    ...
    descricaoCurta: 'A feijoada baiana é rica em carnes e temperos, feita com feijão mulatinho ou preto.',
    sobre: 'Diferente da versão carioca, a feijoada baiana tradicionalmente utiliza feijão mulatinho (ou carioquinha) e inclui carnes como charque, calabresa, toucinho e um toque especial de temperos locais. É um prato robusto, ideal para reunir a família nos finais de semana.',
  ...
  },
  {
    ...
    sobre: 'O acarajé é uma especialidade gastronômica da culinária afro-brasileira, feito de massa de feijão-fradinho, cebola e sal, frito em azeite de dendê. Pode ser servido com pimenta, camarão seco, vatapá, caruru e salada. É um símbolo forte da cultura baiana.',
    categoria: 'Entrada',
    tempoPreparo: '60 min',
    dificuldade: 'Difícil',
